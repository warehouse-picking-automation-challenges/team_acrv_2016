...
class ToggleRealsenseKinect(smach.State):
    def __init__(self, action='realsense_off_kinect_on'):
        ...
        kinfu_reset = '/ros_kinfu/reset'
        kinfu_pause = '/ros_kinfu/pause'
        ...
        self.kinfu_reset_pub = rospy.Publisher(kinfu_reset,Empty)
        self.kinfu_pause_pub = rospy.Publisher(kinfu_reset,Empty)
