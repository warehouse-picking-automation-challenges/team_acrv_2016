...
class StowSuccessfulState(smach.State):
    """ Call this state whenever a stow operation was successful. It will update the mission plan
        ...
        Use the PickSuccessfulState if you are in picking mode!
    """
    ...
    def execute(self, userdata):
        ...
        try:
            ...
            request.from_bin = 'tote'
            request.to_bin = userdata['next_item_to_pick']['bin']
            ...
            if response.success:
                ...
                rospy.logwarn('Something went wrong when calling MoveItem from the StowSuccessfulState.')
