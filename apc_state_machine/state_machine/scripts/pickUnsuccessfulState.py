...
class PickUnsuccessfulState(smach.State):
    """ Call this state whenever a pick operation was unsuccessful. It will update the mission plan
        ...
        Use the StowUnsuccessfulState if you are in stowing mode!
    """
    ...
    def execute(self, userdata):
        ...
        try:
            ...
            return 'succeeded'
            # else:
            #     rospy.logwarn('Something went wrong when calling MoveItem from the PickUnsuccessfulState.')
